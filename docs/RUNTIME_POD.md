...
| A model call that spends its whole allowance, leaving no answer, no usage and no cost, and ending the delivery where it was asked | `internal/worker` `TestAModelCallThatRunsOutOfItsAllowanceIsAskedOnceMore` | live, 2026-09-09 (the reception, after thirteen runs) |
