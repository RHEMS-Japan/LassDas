...
func TestClassifyRunNamesEveryPipelinePosition(t *testing.T) {
	...
	cases := map[string]struct {
		...
		"implement running":          {run: state.RunOverview{State: "claimed"}, tasks: []runtime.BoardTask{chainCard("implement", 1, "running"), chainCard("review-a", 1, "todo"), chainCard("validate", 1, "todo"), chainCard("publish", 1, "todo")}, wantStep: "implement"},
		...
		"review before pending tail": {run: state.RunOverview{State: "claimed"}, tasks: []runtime.BoardTask{chainCard("implement", 1, "done"), chainCard("review-a", 1, "running"), chainCard("review-b", 1, "todo"), chainCard("validate", 1, "todo"), chainCard("publish", 1, "todo")}, wantStep: "review"},
