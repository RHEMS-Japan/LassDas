...
| A sealed review that exists and cannot be read, counted as a review that found nothing wrong: the delivery went back to the applier with a design a reviewer may have called wrong, and no record anywhere said the decision had been made that way | `internal/attendant` `TestAnUnreadableSealedReviewCountsAsRejectingTheDesign` | audit, 2026-09-09 |
