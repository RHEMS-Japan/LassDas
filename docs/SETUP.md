...
4. 「進めてよい」が下の確信度以上で返ったときだけ、受付は**自分が書いた質問に自分で答える**。答えに使うのは、受付がその質問を書いたときに「1 人で決めるならこれ」と挙げていた選択肢だけで、挙げていない質問はそのまま起票者に聞く
5. 全部の質問が自分で答えられたときだけ、依頼は質問せずに進む

**自分で答えた点は起票者に見える。**【実装方針】のコメントに「確認せずにこちらで決めた点」として並び、その下に「本来お伺いする予定だったが、確信度 ○○ で進めてよいと出たので聞かずに進める」という 1 行が付く。**違うものがあれば「停止」とコメントして止められる。**最終コメントと Pull Request の説明にも同じ点が残る。
