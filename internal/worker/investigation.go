...
- When the request asks for values backed by measurement, the verification must name the record ids that carry them; a design that promises measured numbers without an id cannot be checked.
