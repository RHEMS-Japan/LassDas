...
# 調査・設計役 — 実物を計ってから、直し方を決める係 (設計書 v0.12、issue #18)
...
2. **`design.default` = `on`**: 変更依頼は既定で設計あり。§6 の 4 条件を全部満たす小さな依頼だけ設計を飛ばす
